...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --file=filename   file to read",
  "  -b, --batch=filename  file with batch of files to read",
  "  -d, --dir=dirname     directory to read and analyze files",
    0
};
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* file to read.  */
          ...
          break;
        case 'b':	/* file with batch of files to read.  */
          ...
          break;
        case 'd':	/* directory to read and analyze files.  */
